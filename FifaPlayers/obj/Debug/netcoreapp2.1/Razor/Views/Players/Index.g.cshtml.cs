#pragma checksum "C:\Users\Thomas\Source\Repos\FifaPlayers\FifaPlayers\Views\Players\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8053799642b513151eac94e70640b79a3a2932d6"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8053799642b513151eac94e70640b79a3a2932d6", @"/Views/Players/Index.cshtml")]
...
#line hidden
        ...
        self.clubSearch = function (data, event) {
            ...
            if (currentSearch != """);
            WriteLiteral(@""") {
                $.get(""Clubs/SearchClubs?club="" + currentSearch, function (data) {
    ...
    <div class=""col-lg-8 offset-lg-4"">
        <div id=""clubInput"" class=""input-group"">
            ...
            <div class=""input-group-append"">
                ...
                <div id=""clubDropDown"" class=""dropdown-menu"" data-bind=""fore");
            WriteLiteral(@"ach: clubOptions"">
    ...
    <div data-bind=""foreach: players"">
        <div class=""player"">
            <div class=""row"" data-bind=""click: $root.shout"">
                ...
                <div class=""col-md-2"">Rating: <span data-bind=""text: player.rating""></s");
